#ifndef QTOSGVIEWER_H
#define QTOSGVIEWER_H
//
#include "qtosg.h"
#include <QMainWindow>
...
//  virtual void SetCameraLookAt(const RaveVector<float>& lookat, const RaveVector<float>& campos, const RaveVector<float>& camup);
  ...
  virtual osg::Group* GetRoot() { return _ivRoot; }
...
protected:
  ...
  inline QtOSGViewerPtr shared_viewer() { return boost::static_pointer_cast<QtOSGViewer>(shared_from_this()); }
  inline QtOSGViewerConstPtr shared_viewer_const() const { return boost::static_pointer_cast<QtOSGViewer const>(shared_from_this()); }
