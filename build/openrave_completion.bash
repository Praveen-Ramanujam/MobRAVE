...
function _complete_openravepy {
        ...
        if [[ $COMP_CWORD == 2 ]]; then
            case ${COMP_WORDS[1]} in
                --listinterfaces)
                    ...
                    ;;
                --example)
                    opts=`openrave0.5.py --listexamples`
                    COMPREPLY=($(compgen -W "$opts" -- ${cur}))
                    return 0
                    ;;
                --database)
                    opts=`openrave0.5.py --listdatabases`
                    COMPREPLY=($(compgen -W "$opts" -- ${cur}))
                    return 0
                    ;;
            esac
    ...
    case "${prev}" in
        --level|-l)
            ...
            ;;
        --collision)
            opts=`openrave0.5.py --listinterfaces collisionchecker`
            COMPREPLY=($(compgen -W "$opts" -- ${cur}))
            return 0
            ;;
        --viewer)
            opts=`openrave0.5.py --listinterfaces viewer`
            COMPREPLY=($(compgen -W "$opts" -- ${cur}))
            return 0
            ;;
        --physics)
            opts=`openrave0.5.py --listinterfaces physics`
            COMPREPLY=($(compgen -W "$opts" -- ${cur}))
            return 0
            ;;
        --loadplugin)
...
complete -F "_complete_openravepy" -o filenames -o plusdirs "openrave0.5.py"
complete -F "_complete_openrave_robotpy" -o filenames -o plusdirs "openrave0.5-robot.py"
complete -F "_complete_openrave_createpluginpy" "openrave0.5-createplugin.py"
