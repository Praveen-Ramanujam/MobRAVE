...
public:
        ...
        std::vector<RaveVector<dReal> > ranges;         ///< Range and direction readings in the form of direction*distance. The direction is in world coordinates.
        std::vector<dReal> intensity;         ///< Intensity readings.

        virtual bool serialize(std::ostream& O) const;
    };
    class OPENRAVE_API TouchSensorData : public SensorData
    {
public:
        virtual SensorType GetType() {
            return ST_Touch;
...
public:
    ...
    class OPENRAVE_API TouchGeomData : public SensorGeometry
    {
public:
        TouchGeomData() : min_range(0), max_range(0), time_increment(0), time_scan(0) {
            min_angle[0] = min_angle[1] = max_angle[0] = max_angle[1] = resolution[0] = resolution[1] = 0;
        }
