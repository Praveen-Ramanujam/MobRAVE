...
#define OPENRAVE_VERSION_MINOR 5
...
#define OPENRAVE_VERSION_STRING "0.5.0"
...
#define OPENRAVE_PLUGINS_INSTALL_DIR "/usr/local/share/openrave-0.5/plugins"
#define OPENRAVE_DATA_INSTALL_DIR "/usr/local/share/openrave-0.5"
#define OPENRAVE_PYTHON_INSTALL_DIR "/usr/local/lib/python2.6/dist-packages"
