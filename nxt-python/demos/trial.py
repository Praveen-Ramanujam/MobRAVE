...
while(1):
	...
	fdata = front_sonar.GetData()
    	...
    	if fdata.intensity[0] == 0 and (fdata.intensity[16] == 1 or fdata.intensity[15] ==1):
		dn = 0
	elif fdata.intensity[16] == 1 or fdata.intensity[15] ==1:
		dn = 0
	else:
		dn = 0
    cont.SetDesired(([dn*steer, 0, dn*steer, 0, 2, 3]))
